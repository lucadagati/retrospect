...
#define MASK_LITTLE_ENDIAN (1U << 0)
#define MASK_SOFT_FLOAT (1U << 1)
#define MASK_MEMCPY (1U << 2)
#define MASK_PIC_DATA_TEXT_REL (1U << 3)
#define MASK_SMALL_DIVIDES (1U << 4)
#define MASK_BARREL_SHIFT (1U << 5)
#define MASK_FLOAT_CONVERT (1U << 6)
#define MASK_FLOAT_SQRT (1U << 7)
#define MASK_XLGPOPT (1U << 8)
#define MASK_XL_MODE_BOOTSTRAP (1U << 9)
#define MASK_XL_MODE_EXECUTABLE (1U << 10)
#define MASK_XL_MODE_NOVECTORS (1U << 11)
#define MASK_XL_MODE_XMDSTUB (1U << 12)
#define MASK_MULTIPLY_HIGH (1U << 13)
#define MASK_PATTERN_COMPARE (1U << 14)
#define MASK_PREFETCH (1U << 15)
#define MASK_SOFT_DIV (1U << 16)
#define MASK_SOFT_MUL (1U << 17)
#define MASK_STACK_CHECK (1U << 18)
...
enum opt_code
{
  ...
  OPT_mcpu_ = 1771,                          /* -mcpu= */
  OPT_mhard_float = 1772,                    /* -mhard-float */
  OPT_mlittle_endian = 1773,                 /* -mlittle-endian */
  OPT_mmemcpy = 1774,                        /* -mmemcpy */
  OPT_mno_clearbss = 1775,                   /* -mno-clearbss */
  OPT_mpic_data_is_text_relative = 1776,     /* -mpic-data-is-text-relative */
  OPT_msmall_divides = 1777,                 /* -msmall-divides */
  OPT_msoft_float = 1778,                    /* -msoft-float */
  OPT_mxl_barrel_shift = 1779,               /* -mxl-barrel-shift */
  OPT_mxl_float_convert = 1780,              /* -mxl-float-convert */
  OPT_mxl_float_sqrt = 1781,                 /* -mxl-float-sqrt */
  OPT_mxl_gp_opt = 1782,                     /* -mxl-gp-opt */
  OPT_mxl_mode_bootstrap = 1783,             /* -mxl-mode-bootstrap */
  OPT_mxl_mode_executable = 1784,            /* -mxl-mode-executable */
  OPT_mxl_mode_novectors = 1785,             /* -mxl-mode-novectors */
  OPT_mxl_mode_xilkernel = 1786,             /* -mxl-mode-xilkernel */
  OPT_mxl_mode_xmdstub = 1787,               /* -mxl-mode-xmdstub */
  OPT_mxl_multiply_high = 1788,              /* -mxl-multiply-high */
  OPT_mxl_pattern_compare = 1789,            /* -mxl-pattern-compare */
  OPT_mxl_prefetch = 1790,                   /* -mxl-prefetch */
  OPT_mxl_reorder = 1791,                    /* -mxl-reorder */
  OPT_mxl_soft_div = 1792,                   /* -mxl-soft-div */
  OPT_mxl_soft_mul = 1793,                   /* -mxl-soft-mul */
  OPT_mxl_stack_check = 1794,                /* -mxl-stack-check */
  OPT_n = 1795,                              /* -n */
