...
│   ├── RENODE_TLS_DEPLOY_VERIFICATION.md  # TLS and deploy verification
│   ├── DASHBOARD_API_K8S_VERIFICATION.md # Dashboard API vs K8s
│   ├── REPO_ANALYSIS.md            # Repository analysis (useful / removed / not implemented)
│   ├── WASMBED_CAPABILITIES.md     # Device/app capabilities and protocol
