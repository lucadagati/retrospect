...
use crate::indexmap_compat::IndexMap;
use core::mem;
...
pub(crate) struct ModuleState {
    ...
    /// functions. Note that this starts out as a solely owned `Rc<T>` so we can
...
pub(crate) struct Module {
    ...
    pub snapshot: Option<Rc<TypeList>>,
...
pub struct ValidatorResources(pub(crate) Rc<Module>);
