...
use alloc::fmt::{self, Debug, Write};
...
impl core::fmt::Debug for PackedIndex {
...
impl core::fmt::Display for PackedIndex {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        core::fmt::Display::fmt(&self.unpack(), f)
    }
}
...
impl core::fmt::Display for UnpackedIndex {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
...
impl RecGroup {
    ...
    pub fn into_types(self) -> impl ExactSizeIterator<Item = SubType> {
        ...
        enum Iter {
            ...
            Explicit(alloc::vec::IntoIter<SubType>),
        }
...
impl core::fmt::Display for ValType {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ...
            ValType::Ref(r) => core::fmt::Display::fmt(r, f),
        }
    }
}
